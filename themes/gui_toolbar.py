    ...
    with gr.Floating(init_x="0%", init_y="0%", visible=True, width=None, drag="forbidden", elem_id="tooltip"):
        with gr.Row():
            ...
            with gr.Tab("更换模型", elem_id="interact-panel"):
                ...
                top_p = gr.Slider(minimum=-0, maximum=1.0, value=0.9, step=0.01,interactive=True, label="Top-p (nucleus sampling)",)
                temperature = gr.Slider(minimum=-0, maximum=2.0, value=0.8, step=0.01, interactive=True, label="Temperature", elem_id="elem_temperature")
